...
export const TechPartCard = ({ imgsrc, link }) => {
    return (
        <div className='p-4 bg-[#FFAB2E] bg-opacity-25 rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.12)] space-y-1 flex flex-col flex-wrap justify-center items-center '>
            ...
            <div className='relative h-[60px] w-[120px] z-[100] md:h-[160px] md:w-[250px]'>
