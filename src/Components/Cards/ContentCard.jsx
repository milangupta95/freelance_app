...
export const ContentCard = ({ content }) => {
    return (
        <div className='bg-[#FFF0DA] text-black space-y-4 p-4 md:w-[300px] w-full shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] rounded-lg'>
