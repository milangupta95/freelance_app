...
export const BenifitCard = ({title,description,imagesrc}) => {
    return (
        <div className='w-full md:w-fit relative'>
            ...
            <div className='space-y-6 md:w-[330px] w-full md:h-[350px] h-full flex flex-col items-center mt-[-15px] md:pt-8 pt-6 shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] rounded-lg'>
                <Image alt='' height={80} width={80} src={imagesrc}/>
