...
export const BenifitCard = ({title,description,imagesrc}) => {
    return (
        <div className='w-full md:w-fit relative'>
            <div className='md:w-[200px] w-[75%] border-4 border-[#F19F1F] bg-[#FFFFFF] z-[1001] tracking-wide py-2 mx-[15%] md:mx-[22%] text-xs md:text-lg'><p className='text-center'>{title}</p></div>
