...
export default function Page() {
    ...
    return (
        <div className="bg-white space-y-4">
            <PageStarter tit1={"Events"} tit2={""} tit1Col={"black"} descColor={"black"} imageSrc={"/images/blogsHeader.jpg"} desc={"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt"}></PageStarter>
