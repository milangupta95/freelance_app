            ...
            <div className="bg-gray-100 p-6 sm:p-12">
                <div className="w-full mx-auto bg-white text-black p-8 rounded-lg shadow-md">
                    ...
                    <ul className="list-disc list-inside mb-4">
                        ...
                        <li><strong>Website</strong> refers to Intelli Vectra, accessible from <a href="https://www.intellivectra.tech/" className="text-blue-500 underline">https://www.intellivectra.tech/</a></li>
